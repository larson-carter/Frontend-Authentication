  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full">
      <div>
        ...
        <h2 class="mt-6 text-center text-3xl leading-9 font-extrabold text-gray-900">Signup</h2>
        ...
        <div class="mt-6">
          ...
          >
            <span class="absolute left-0 inset-y-0 flex items-center pl-3">
              <svg
                class="h-5 w-5 text-yellow-500 group-hover:text-yellow-900 transition ease-in-out duration-150"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
